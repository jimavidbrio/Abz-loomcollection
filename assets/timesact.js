        ...
        class Badge {
            ...
            applyStyles(style, settingType) {
                ...
                $(`.timesact-badge-common-${settingType}`).css({
                    "position": "absolute",
                    ...this.getPositions(isTop, isRight, "10px", "40px"),
                    "display": "flex",
                    "flex-wrap": "wrap",
                    "font-family": "Nunito Sans,sans-serif",
                    "z-index": "1"
        ...
        class ShopUtil {
            ...
            initTimesact() {
                ...
                window.ta = {
                    ...
                    quickView: {
                        selectors: {
                            button: ".quickbuy-toggle, .quick-add__submit, .productitem--action-qs, .boost-pfs-quickview-btn, .cc-quick-buy-btn, .button--quick-shop, .sca-qv-button, .quick-view-btn, .bc-quickview-btn-wrapper, .sca-qv-cartbtn, .js-quick-shop-link, .searchit-quick-view-button, .quick-view, .js-quickbuy-button, .quick-product__btn, .product-card-interaction-quickshop, .product-modal, .productitem--action button, a.quickview, .overlay, a.quickview, .has-quick-view .btn .v-b, .shop-now-button, .quick-buy, .quick_shop, a[data-action='show-product'], .trigger-quick-view, .quickview-button, .quick_view, .qview-button, button.btn-addToCart:last, .quick-shop, .fancybox.ajax, .quick-add-button-variants, .product-thumbnail__quickshop-button, .js-quickView-button",
                            ...
                            quickviewModalContainer: ".quickbuy-content"
                        }
                    }
                }
            }
            ...
            createQuickViewButtonListener() {
                ...
                $(window.ta.quickView.selectors.button).click(function (target) {
                    ...
                    var product;
                    thisShop.sleep(1000).then(function() {
